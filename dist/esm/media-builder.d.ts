...
import { UploadCallbacks, MediaData, MediaEventMap, RequestsCallback, RequestCallback, UploadRequestsCallback, SearchPaginationData } from './index';
...
export declare function resumeStream(id: string): Promise<MediaData>;
export declare function retryStream(id: string): Promise<MediaData>;
export declare function deleteStream(id: string): Promise<MediaData>;
