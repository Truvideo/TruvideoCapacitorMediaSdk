var capacitorTruvideoSdkMedia = (function (exports, core) {
    ...
    async function getAllUploadRequests() {
        let response = await TruvideoSdkMedia.getAllUploadRequests();
        return parsePluginResponse(response, "requests");
    }
    async function getUploadRequestById(id) {
    ...
    async function streamAllUploadRequests(callbacks) {
        if (callbacks) {
        ...
        const initial = parsePluginResponse(response, "requests");
    ...
    async function stopAllUploadRequests() {
        if (allUploadStreamListenerHandle) {
    ...
    exports.getAllUploadRequests = getAllUploadRequests;
    exports.getFileUploadRequestById = getFileUploadRequestById;
    exports.getUploadRequestById = getUploadRequestById;
    ...
    exports.stopAllUploadRequests = stopAllUploadRequests;
